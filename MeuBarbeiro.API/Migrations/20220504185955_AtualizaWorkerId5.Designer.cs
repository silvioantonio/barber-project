...
namespace MeuBarbeiro.API.Migrations
{
    ...
    [Migration("20220504185955_AtualizaWorkerId5")]
    partial class AtualizaWorkerId5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeuBarbeiro.API.Models.Appointment.Appointment", b =>
                {
                    ...
                    b.Property<long>("ProviderHourId")
                        .HasColumnType("bigint")
                        .HasColumnName("provider_hour_id");
            ...
            modelBuilder.Entity("MeuBarbeiro.API.Models.Worker.Worker", b =>
                {
                    b.HasOne("MeuBarbeiro.API.Models.Provider.Provider", null)
                        .WithMany("Workers")
